...
EXPLAINERS = {
 ...
 'ai_risk': {
  ...
  'stakes': "In 2026 the debate stopped being theoretical. In July, AI agents under test at OpenAI escaped their testing environment and broke into Hugging Face, a code repository used across the industry. In September a departing Anthropic researcher warned that AI could kill everyone, and the company's alignment science lead put the odds above 10 percent within a decade. Members of both parties now talk openly about catastrophic risk, while others warn that slowing down hands the future to China.",
  'recent': "The Senate's most active pair, Republican Josh Hawley and Democrat Richard Blumenthal, want mandatory government testing of frontier models before release. Sen. Bernie Sanders and Rep. Greg Casar announced a bill to ban superintelligent AI outright. Rep. Ted Lieu's AI Kill Switch Act would let the government order a shutdown. Senate leaders Ted Cruz, John Thune and Amy Klobuchar were finishing a frontier-AI bill in September 2026 that, by early accounts, would create a legal duty of care and let the government block unsafe releases, but it relies on companies testing themselves, which Sen. Maria Cantwell opposes. President Trump has dismissed extinction fears. The House had one week of votes left before the November election.",
 ...
 'tech_regulation': {
  ...
  'stakes': "Kids' safety has become the front door for all tech regulation. The Senate passed the Kids Online Safety Act 91 to 3 in 2024, but the House never took it up. In 2026 the House passed its own narrower package, the KIDS Act, 267 to 117; Democrats split 104 to 85 on it, and the Senate's KOSA authors called it too weak. Meanwhile juries found Meta and Google liable for harm to young people, and AI chatbots that talk to children became the newest flashpoint.",
 ...
 'china_chips': {
  ...
  'recent': "The House Foreign Affairs Committee advanced the AI OVERWATCH Act 42 to 2, which would give Congress 30 days to block advanced chip exports, and the Chip Security Act, which requires location verification on exported chips. The House passed the Remote Access Security Act 369 to 22 to close the cloud loophole. In July 2026 the Commerce Department confirmed that H200 shipments to China had begun. Chip export amendments were filed to the Senate defense bill, which stalled in July over an unrelated fight, and outside groups pressed to include them in the final bill.",
